...
/*   Updated: 2023/05/27 00:35:53 by wbouwach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	piping(char **cmd, int infile, int outfile,
			char **env, t_env *env_list, int *token);
...
void	multi_pipes_execution(t_cmd_data *cmd_data,
			t_redirection *redirection, char **env, t_env *env_list);
...
void	single_cmd_execution(t_cmd_data *cmd_data,
			t_redirection *redirection, char **env, t_env *env_list);
...
int		get_output_redirection_index(int *cmd_tokens,
...
void	single_cmd_execution1(t_cmd_data *cmd_data,
			t_redirection *redirection, char **env, t_env *env_list);
...
void	execute_line(t_cmd_data *cmd_data, t_redirection *redirection, char **env,
